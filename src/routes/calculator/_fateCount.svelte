  ...
  let fateValues = [
    {
      ...
      name_path: 'calculator.fateCount.interwinedFate',
      image: '/images/intertwined_fate.png',
      amount: 0,
    },
    {
      id: 'starglitter',
      name: $t('calculator.fateCount.starglitter'),
      name_path: 'calculator.fateCount.starglitter',
      image: '/images/starglitter.png',
      amount: 0,
    },
    {
      id: 'stardust',
      name: $t('calculator.fateCount.stardust'),
      name_path: 'calculator.fateCount.stardust',
      image: '/images/stardust.png',
      amount: 0,
    },
    {
      id: 'primogem',
      name: $t('calculator.fateCount.primogem'),
      name_path: 'calculator.fateCount.primogem',
    ...
    },
    {
      ...
      name_path: 'calculator.fateCount.genesisCrystal',
      image: '/images/genesis_crystal.png',
      amount: 0,
    },
    {
      id: 'welkinMoon',
      name: $t('calculator.fateCount.welkinMoon'),
      name_path: 'calculator.fateCount.welkinMoon',
      image: '/images/welkin_moon.png',
      amount: 0,
    },
  ];

  let parameters = [
    { name: $t('calculator.fateCount.days'), name_path: 'calculator.fateCount.days', amount: 0 },
    { name: $t('calculator.fateCount.monthStardust'), name_path: 'calculator.fateCount.monthStardust', amount: 5 },
  ];
        ...
        {#each fateValues as value}
          <div class="mb-1 rounded-xl border-background border p-2">
            <div class="flex flex-row items-center mb-1">
              ...
              <p class="text-white">{$t(value.name_path)}</p>
            </div>
