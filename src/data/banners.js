export const banners = {
  ...
  weapons: [
    ...
    },
    {
      ...
      featuredRare: ['the_flute', 'the_bell', 'favonius_lance', 'favonius_codex', 'rust'],
      version: '6.4',
    },
    {
      name: 'Epitome Invocation',
    ...
    },
    {
      ...
      color: '#eae5e1',
      featured: ['nightweavers_looking_glass', 'reliquary_of_truth'],
      featuredRare: ['dawning_frost', 'sacrificial_sword', 'rainslasher', 'favonius_lance', 'favonius_warbow'],
      version: '6.5',
    },
    {
      name: 'Epitome Invocation',
      ...
      featuredRare: ['moonweavers_dawn', 'mitternachts_waltz', 'the_bell', 'dragons_bane', 'the_widsith'],
      version: '6.6',
      timezoneDependent: true,
    },
    {
      ...
      featuredRare: ['the_alley_flash', 'wine_and_song', 'alley_hunter', 'rainslasher', 'favonius_lance'],
      version: '6.6',
    },
    {
      name: 'Epitome Invocation',
      ...
      color: '#ffb169',
      featured: ['a_teaspoon_of_transcendence', 'starcallers_watch'],
      featuredRare: ['favonius_sword', 'rainslasher', 'dragons_bane', 'sacrificial_fragments', 'sacrificial_bow'],
      version: '6.7',
      timezoneDependent: true,
    },
    {
      ...
      featuredRare: ['waveriding_whirl', 'sacrificial_sword', 'the_bell', 'favonius_lance', 'favonius_warbow'],
      version: '6.7',
    },
  ],
  chronicled: [
