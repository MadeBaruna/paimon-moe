  ...
  thoma: {
    roles: {
      SUPPORT: {
        ...
        artifacts: [['noblesse_oblige'], ['tenacity_of_the_millelith', 'emblem_of_severed_fate']],
        mainStats: {
          sands: 'Energy Recharge / HP%',
          goblet: 'HP%',
          circlet: 'HP%',
        ...
        tip: '',
        note:
          '!!WIP!! Thoma ideally wants to focus on shield over damage, and his burst uptime is required to achieve better shields, which is why he needs ER% on top of HP%.\n\nRegarding Weapon Choices:\nBlack Tassel: On Constellation 4, Thoma gains 15 energy when he fires his burst. This effectively reduces his energy cost to 65 and makes it possible to use Black Tassel with ER sands instead of ER weapon with ER sands.',
      },
    },
  },
  diluc: {
  ...
  sangonomiya_kokomi: {
    roles: {
      SUPPORT: {
        ...
        artifacts: [['tenacity_of_the_millelith'], ['maiden_beloved'], ['maiden_beloved', 'tenacity_of_the_millelith']],
        mainStats: {
      ...
      DPS: {
        ...
        artifacts: [
          ['heart_of_depth'],
          ['maiden_beloved', 'heart_of_depth', 'tenacity_of_the_millelith'],
          ['tenacity_of_the_millelith'],
        ],
        mainStats: {
        ...
        tip: '',
        note:
          "DPS Kokomi aims to maximise her onfield damage only during her Elemental Burst's duration. Outside of her Elemental Burst, her damage is lackluster and not worth building for.\n\nRegarding Weapon Choices:\nThrilling Tales of Dragon Slayer: Although this weapon doesn't provide as much personal damage for Kokomi, the 48% ATK buff is usually more worth in most cases. This can be her best weapon in for overall team DPS if you don't already have another Thrilling Tales user in your team.\nHakushin Ring: This weapon can provide Elemental DMG% for the team in Electro-charged teams, and will usually be the best choice in those situations.\n\nRegarding Artifact Choices:\nTenacity of the Milelith (4): Although this set offers the lowest personal dmg for Kokomi, the 20% ATK team buff is usually more worth for overall team DPS.",
      },
    },
  },
  diona: {
  ...
  jean: {
    roles: {
      DPS: {
        ...
        subStats: [' Crit Rate / DMG', ' ATK%', ' Energy Recharge', ' Elemental Mastery', ' Flat Attack'],
        talent: [' Normal Attack', ' Skill', ' Burst'],
        tip:
  ...
  ningguang: {
    roles: {
      ...
      'SUB DPS / NUKE': {
        ...
        note:
          "This section is dedicated towards a quickswap style Ningguang, where she outputs high burst damage in an extremely short time window before swapping out to other supports.\n\nRegarding Weapon Choices: \nWidsith: Widsith is ranked lowly due to the playstyle not aligning with its downtime. (You might get 1-2 Burst rotations without buff active, depending on how quickly you rotate your supports) For this reason, its average DPS is below Solar Pearl.\n\nRegarding Weapons Ranking with Bennett's Burst considered: With Bennett burst considered, Solar Pearl and Lost Prayer will be ranked above Memory of Dust, with Solar Pearl outperforming LP at [R2+]. This is because in a quickswap composition, it is difficult to develop and maintain stacks on a Lost Prayer. (5 star weapons R1 assumed.) (All other rankings remain the same.)",
      },
    },
  },
  noelle: {
    roles: {
      ...
      SUPPORT: {
        ...
        artifacts: [['defenders_will', 'maiden_beloved']],
        mainStats: {
          sands: 'DEF%',
          goblet: 'DEF%',
          circlet: 'DEF%',
  ...
  traveler_geo: {
    roles: {
      'GEO DPS': {
        ...
        note:
          "This section is dedicated to utilising the Geo Traveller's Geo Elemental Burst damage capabilities. Due to how little field time this playstyle takes, the traveller can also fulfill the role of a quickswap style Sub-DPS.\nRegarding Weapon Choices: Festering Desire, Skyward Blade, Amenoma Kageuchi: These weapons help in bursting off cooldown, but if you're not having issues with energy, then these weapons falls behind in terms of damage.",
      },
      'PHYSICAL DPS': {
        recommended: false,
        weapons: [
