  ...
  shikanoin_heizou: {
    roles: {
      'ANEMO DPS': {
        ...
        artifacts: [['viridescent_venerer'], ['viridescent_venerer', '+18%_atk_set', 'wanderers_troupe']],
        mainStats: {
          sands: ['ATK%'],
          goblet: ['Anemo DMG'],
